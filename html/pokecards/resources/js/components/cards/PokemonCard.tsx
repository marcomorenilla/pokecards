...
import { useResponsiveContext } from '@/js/hooks/useResponsiveContext';

const TiltComponent = Tilt as any;
...
export function PokemonCard({ pokemon, parent, quantity }: CardProps) {
    ...
    const { onResponsiveClick } = useResponsiveContext() || {};

    const handleCardClick = () => {
        if (onCardClick) onCardClick(pokemon);
        if (onResponsiveClick) onResponsiveClick(pokemon);
    };
    ...
    return (
        <TiltComponent tiltReverse={true}>
            <div
            ...
            >
                ...
                >
                    ...
                    <section
                        className={`${mainTextSize} font-bold text-gray-800`}
                    >
